...
public class Server {
	...
	public void wlaczSie() {
		...
		int portNumber = 3333;
		/*
		 * ﻿ ﻿ * Open a server socket on the portNumber (default 2222). Note
		 * that we ﻿ ﻿ * can not choose a port less than 1023 if we are not
		...
		while (true) {
			try {
				...
				// new table// jesli jednak nie znalazlem wolnego miejsca to
				// wyczerpany
